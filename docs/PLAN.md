...
│         │                                                                                     │
│  web UI (React): Ростер · Персонаж · Лут-таблицы · Лут-ночь · Настройки                       │
...
- UI «Лут-ночь»: экран текущего рейда — по каждому предмету босса список персонажей, отсортированный по выгоде; параллельно дублирует то, что в игре видит совет.
